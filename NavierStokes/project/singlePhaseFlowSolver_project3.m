%% Specificy domain size,# of cells in x,y and mesh resolution
...
obsWidth = 0.25*xe; % Width of obstacle
obsHeight = 0.25*ye; % Height of obstacle
...
while t < iter
    ...
    % dt = stabilityCondition(u,v,nx,ny,dx); % CFL condition - twoPhaseFlow
...
xlabel('X-coordinate(m)')
ylabel('Y-coordinate(m)')
iverts = interpstreamspeed(x,y,U,V,verts,0.02)
